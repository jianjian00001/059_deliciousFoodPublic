	...
	<div class="detail-preview" :style='{"padding":"0 0 24px","margin":"0px auto","flexWrap":"wrap","display":"flex","width":"1200px","position":"relative","justifyContent":"space-between"}'>
		<div class="attr" :style='{"border":"1px solid #eee","padding":"12px 0px 20px 0px","boxShadow":"0px 0px 0px #ddd,inset 0px 0px 0px 0px #e0f8e8","margin":"20px 0 20px 0","display":"flex","justifyContent":"space-between","minHeight":"600px","overflow":"hidden","borderRadius":"4px","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20221123/02b65dd190a741a1ae9c37c17624c5aa.jpg) fixed center top no-repeat,#d4f2f3","width":"1200px","position":"relative"}'>
			...
			<div class="info" :style='{"width":"575px","padding":"0px 0 20px","margin":"20px auto 0 auto","background":"none","height":"auto","order":"2"}'>
				...
				<div class="item" :style='{"padding":"0px 10px","boxShadow":"0px 0px 0px #ddd","margin":"0 0 6px 0","borderColor":"#ddd","borderRadius":"0px","background":"rgba(255,255,255,.6)","borderWidth":"1px 1px 1px 1px","display":"flex","borderStyle":"dashed","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"130px","fontSize":"14px","lineHeight":"40px","minWidth":"130px"}'>分数</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","height":"auto"}'>{{detail.fenshu}}</div>
				</div>
				<div class="item" :style='{"padding":"0px 10px","boxShadow":"0px 0px 0px #ddd","margin":"0 0 6px 0","borderColor":"#ddd","borderRadius":"0px","background":"rgba(255,255,255,.6)","borderWidth":"1px 1px 1px 1px","display":"flex","borderStyle":"dashed","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"130px","fontSize":"14px","lineHeight":"40px","minWidth":"130px"}'>评测目的</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","height":"auto"}'>{{detail.pingcemude}}</div>
				</div>
				<div class="item" :style='{"padding":"0px 10px","boxShadow":"0px 0px 0px #ddd","margin":"0 0 6px 0","borderColor":"#ddd","borderRadius":"0px","background":"rgba(255,255,255,.6)","borderWidth":"1px 1px 1px 1px","display":"flex","borderStyle":"dashed","justifyContent":"spaceBetween"}'>
				...
				<div class="item" :style='{"padding":"0px 10px","boxShadow":"0px 0px 0px #ddd","margin":"0 0 6px 0","borderColor":"#ddd","borderRadius":"0px","background":"rgba(255,255,255,.6)","borderWidth":"1px 1px 1px 1px","display":"flex","borderStyle":"dashed","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"130px","fontSize":"14px","lineHeight":"40px","minWidth":"130px"}'>发起时间</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","height":"auto"}'>{{detail.faqishijian}}</div>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0px solid #ffc800","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#00adb5","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('dazhongceping','评分')" @click="onAcross('pingfenxinxi','','[1]','已评分')" type="warning">评分</el-button>
				</div>
			</div>
  ...
  export default {
    ...
    methods: {
      ...
      onAcross(acrossTable,crossOptAudit,statusColumnName,tips,statusColumnValue){
        localStorage.setItem('crossTable',`dazhongceping`);
      ...
      getStoreupStatus(){
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'dazhongceping', userid: localStorage.getItem('userid')}}).then(res => {
      ...
      getDiscussList(page) {
        this.$http.get('discussdazhongceping/list', {params: {page, limit: this.pageSize, refid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
      ...
      submitForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$http.post('discussdazhongceping/add', this.form).then(res => {
              if (res.data.code == 0) {
                this.form.content = '';
                this.getDiscussList(1);
                this.$message({
