  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        this.$http.get('discussjiankanghuodong/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/discussjiankanghuodongDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
