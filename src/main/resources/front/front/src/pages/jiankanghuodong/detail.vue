		...
		<div class="attr" :style='{"border":"1px solid #eee","padding":"12px 0px 20px 0px","boxShadow":"0px 0px 0px #ddd,inset 0px 0px 0px 0px #e0f8e8","margin":"20px 0 20px 0","display":"flex","justifyContent":"space-between","minHeight":"600px","overflow":"hidden","borderRadius":"4px","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20221123/02b65dd190a741a1ae9c37c17624c5aa.jpg) fixed center top no-repeat,#d4f2f3","width":"1200px","position":"relative"}'>
			...
			<div class="info" :style='{"width":"575px","padding":"0px 0 20px","margin":"20px auto 0 auto","background":"none","height":"auto","order":"2"}'>
				...
				<div class="item" :style='{"padding":"0px 10px","boxShadow":"0px 0px 0px #ddd","margin":"0 0 6px 0","borderColor":"#ddd","borderRadius":"0px","background":"rgba(255,255,255,.6)","borderWidth":"1px 1px 1px 1px","display":"flex","borderStyle":"dashed","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"130px","fontSize":"14px","lineHeight":"40px","minWidth":"130px"}'>分类</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","height":"auto"}'>{{detail.fenlei}}</div>
				</div>
				<div class="item" :style='{"padding":"0px 10px","boxShadow":"0px 0px 0px #ddd","margin":"0 0 6px 0","borderColor":"#ddd","borderRadius":"0px","background":"rgba(255,255,255,.6)","borderWidth":"1px 1px 1px 1px","display":"flex","borderStyle":"dashed","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"130px","fontSize":"14px","lineHeight":"40px","minWidth":"130px"}'>作者</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","height":"auto"}'>{{detail.zuozhe}}</div>
				</div>
				<div class="item" :style='{"padding":"0px 10px","boxShadow":"0px 0px 0px #ddd","margin":"0 0 6px 0","borderColor":"#ddd","borderRadius":"0px","background":"rgba(255,255,255,.6)","borderWidth":"1px 1px 1px 1px","display":"flex","borderStyle":"dashed","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"130px","fontSize":"14px","lineHeight":"40px","minWidth":"130px"}'>配方</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","height":"auto"}'>{{detail.peifang}}</div>
				</div>
				<div class="item" :style='{"padding":"0px 10px","boxShadow":"0px 0px 0px #ddd","margin":"0 0 6px 0","borderColor":"#ddd","borderRadius":"0px","background":"rgba(255,255,255,.6)","borderWidth":"1px 1px 1px 1px","display":"flex","borderStyle":"dashed","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"130px","fontSize":"14px","lineHeight":"40px","minWidth":"130px"}'>功效</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","height":"auto"}'>{{detail.gongxiao}}</div>
				</div>
				<div class="item" :style='{"padding":"0px 10px","boxShadow":"0px 0px 0px #ddd","margin":"0 0 6px 0","borderColor":"#ddd","borderRadius":"0px","background":"rgba(255,255,255,.6)","borderWidth":"1px 1px 1px 1px","display":"flex","borderStyle":"dashed","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"130px","fontSize":"14px","lineHeight":"40px","minWidth":"130px"}'>更新时间</div>
			...
			<div class="hot" :style='{"margin":"10px 20px 0px 20px","borderRadius":"8px 8px 0 0","background":"none","width":"1200px","clear":"both","height":"auto","order":"6"}'>
			  ...
			  <div :style='{"padding":"10px 10px 0","boxShadow":"0px 0px 0px #eee,inset 0px 0px 0px 0px #fbf5db","borderColor":"#b4ebc7","borderRadius":"0","flexWrap":"wrap","background":"none","borderWidth":"0 0px 0px 0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","height":"auto"}'>
			    <div v-for="item in hotList" :key="item" :style='{"cursor":"pointer","width":"240px","margin":"0 0 16px","position":"relative","background":"none","height":"auto"}' @click="toDetail(item)">
			      <img :style='{"cursor":"pointer","margin":"0 0 4px","objectFit":"cover","borderRadius":"0px","display":"block","width":"240px","height":"240px"}' :src="baseUrl + (item.fengmian?item.fengmian.split(',')[0]:'')" alt="">
			      <div :style='{"padding":"0 10px","color":"#666","top":"0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20221121/4888ecd54e6e4edca68e6f3ea913ed52.png) no-repeat center top","width":"100%","lineHeight":"40px","fontSize":"14px","position":"absolute","height":"100%","zIndex":"9"}'>{{item.biaoti}}</div>
			      <div :style='{"padding":"0 10px","color":"#666","top":"0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20221121/4888ecd54e6e4edca68e6f3ea913ed52.png) no-repeat center top","width":"100%","lineHeight":"40px","fontSize":"14px","position":"absolute","height":"100%","zIndex":"9"}'>{{item.fenlei}}</div>
			      <div :style='{"padding":"0 10px","color":"#666","top":"0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20221121/4888ecd54e6e4edca68e6f3ea913ed52.png) no-repeat center top","width":"100%","lineHeight":"40px","fontSize":"14px","position":"absolute","height":"100%","zIndex":"9"}'>{{item.zuozhe}}</div>
...
<script>
  ...
  export default {
    ...
    methods: {
        ...
        toDetail(item) {
          this.$router.push({path: '/index/jiankanghuodongDetail', query: {detailObj: JSON.stringify(item)}});
          this.init();
        ...
        getHotList() {
          let autoSortUrl = "";
          autoSortUrl = "jiankanghuodong/autoSort";
          if(localStorage.getItem('Token')) {
              autoSortUrl = "jiankanghuodong/autoSort2";
          }
      ...
      storeup(type) {
        if (type == 1 && !this.isStoreup) {
          ...
          this.storeupParams.inteltype = this.detail.fenlei;
      ...
      getStoreupStatus(){
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'jiankanghuodong', userid: localStorage.getItem('userid')}}).then(res => {
      ...
      getDiscussList(page) {
        this.$http.get('discussjiankanghuodong/list', {params: {page, limit: this.pageSize, refid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
      ...
      submitForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$http.post('discussjiankanghuodong/add', this.form).then(res => {
              if (res.data.code == 0) {
                this.form.content = '';
                this.getDiscussList(1);
                this.$message({
