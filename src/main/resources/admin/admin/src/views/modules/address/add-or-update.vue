	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="收货人" prop="name">
					<el-input v-model="ruleForm.name" placeholder="收货人" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="收货人" prop="name">
					<el-input v-model="ruleForm.name" placeholder="收货人" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="电话" prop="phone">
					<el-input v-model="ruleForm.phone" placeholder="电话" clearable  :readonly="ro.phone"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="电话" prop="phone">
					<el-input v-model="ruleForm.phone" placeholder="电话" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="是否默认地址[是/否]" prop="isdefault">
					<el-input v-model="ruleForm.isdefault" placeholder="是否默认地址[是/否]" clearable  :readonly="ro.isdefault"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="是否默认地址[是/否]" prop="isdefault">
